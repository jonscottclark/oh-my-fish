...
#
#   curl -L https://github.com/jonscottclark/oh-my-fish/raw/master/tools/install.fish \
#   | fish
#
...
if not set -q TRAVIS_REPO_SLUG
  set TRAVIS_REPO_SLUG jonscottclark/oh-my-fish
...
if type git >/dev/null
  ...
  if curl -sLo $fish_path.zip "https://github.com/$TRAVIS_REPO_SLUG/archive/master.zip"
    ...
    log white "Report an issue → github.com/jonscottclark/oh-my-fish/issues"
    exit 1
  end
end
